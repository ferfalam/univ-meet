<template>
    <div class="w-100 my-2 friend-card" style="backgroud-color: #fff; border-radius: 10px">
        <a href="/students/messages">
            <div class="row align-items-center">
                <div class="col col-9">
                    <div class="h4">{{friend.friend.lastname}} {{friend.friend.firstname}}</div>
                    <div class="text-muted"> {{friend.university.name}} </div>
                    <div class="text-muted"> {{friend.field.name}} </div>
                </div>
                <div class="col col-3">
