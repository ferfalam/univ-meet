                        ...
                        <div>
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" v-model="edit_data.name" id="name" placeholder="Nom de l'Uninversité" class= "form-control" />
                                ...
                                <div class="form-group">
                                    <input type="text" v-model="edit_data.acronym" id="acronym" placeholder="Sigle de l'Université" class= "form-control" />
                                ...
                                <div class="row d-flex justify-content-around">
                                    <a rel="nofollow" data-method="delete" href="/universities" class="btn btn-outline-danger">Supprimer ce compte</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
import Navigation from '../../partials/navigationuniversity.vue'
...
export default {
    ...
    mounted() {
        ...
        this.edit_data.name = this.user.name
        this.edit_data.acronym = this.user.acronym
    ...
    methods: {
        editprofil: function(e) {
            let _this = this
            e.preventDefault();
            axios.put('/universities', this.edit_data)
            .then(function (res) {
